...
$(document).ready(function () {
  ...
  $('#maritalStatusId, #countryId, #careerLevelId, #industryId, #functionalAreaId,#stateId,#cityId, #skillId, #languageId').select2({
    'width': 'calc(100% - 44px)'
  });
...
$(document).on('submit', '#addMaritalStatusForm', function (e) {
  ...
  if (!checkSummerNoteEmpty('#martialDescription', 'Description field is required.', 1)) {
    return true;
  }
